...
nw_devices = {'R1': {'capabilities': ['Router', 'Switch'],
        'ip_addr': '10.1.1.1',
        'model': '881,',
        'vendor': 'Cisco'},
 'R2': {'capabilities': ['Router', 'Switch'],
        'ip_addr': '10.1.1.2',
        'model': '881,',
        'vendor': 'Cisco'},
 'R3': {'capabilities': ['Router', 'Switch'],
        'ip_addr': '10.1.1.3',
        'model': '881,',
        'vendor': 'Cisco'},
 'R4': {'capabilities': ['Router', 'Switch'],
        'ip_addr': '10.1.1.4',
        'model': '881,',
        'vendor': 'Cisco'},
 'R5': {'capabilities': ['Router', 'Switch'],
        'ip_addr': '10.1.1.5',
        'model': '881,',
        'vendor': 'Cisco'},
 'SW1': {'capabilities': ['Switch'],
         'ip_addr': '10.1.1.22',
         'model': 'WS-C2950-24,',
         'vendor': 'cisco'}}
...
#print parse_cdp(sw1_show_cdp_neighbors)['local device']

#print sw1_show_cdp_neighbors.split('>show')[0]
